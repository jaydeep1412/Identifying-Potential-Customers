...
if ( isset($_FILES["file"]["type"]) )
{
       ...
       ) && in_array($file_extension, $validextensions))
  {
    ...
    //else
    //{
    //  echo "<div class=\"alert alert-danger\" role=\"alert\">The size of image image you are attempting to upload is " . round($_FILES["file"]["size"]/1024, 2) . " KB, maximum size allowed is " . round($max_size/1024,2) . " KB</div>";
